 ...
 *
 */
@customElement('mememo-panel-setting')
export class MememoPanelSetting extends LitElement {
  //==========================================================================||
  //                              Class Properties                            ||
  //==========================================================================||
  ...
  addButtonClicked(e: MouseEvent) {
    ...
    switch (this.selectedModelFamily) {
      case ModelFamily.google: {
        textGenGemini(apiKey, requestID, prompt, temperature, false)
          .then(value => {
  ...
  confirmClicked() {
    const event = new Event('closeClicked', { bubbles: true, composed: true });
    ...
    return html`
      <div class="panel-setting">
        ...
        <div class="button-block">
          <button class="confirm-button" @click=${() => this.confirmClicked()}>
            Okay
          </button>
        </div>
...
declare global {
  interface HTMLElementTagNameMap {
    'mememo-panel-setting': MememoPanelSetting;
  }
}
